...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.42bb3b19e2dae19efdfda0af8e01436a07a17118f3404157275329f71fcdcd8d.js',function(){input.required=false;search();});}
